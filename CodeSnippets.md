...
- for AI the code is much more complicated, since AIs can not use Quests, which we need to be able to use "LimitToQuestArea". I will add more complex code for AIs later.
